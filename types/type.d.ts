...
// httpClient
export interface HttpClientRequest extends Omit<FetchRequest<Uint8Array>, 'method'> {
    id?: string
    ['binary-mode']?: boolean
}

export interface HttpClientResponse extends Omit<FetchResponse<Uint8Array>, 'body' | 'bodyBytes'> {
}
...
export interface QxFetchResponse extends Omit<FetchResponse<ArrayBuffer>, 'status'> {
    statusCode: number
    sessionIndex?: string
}
