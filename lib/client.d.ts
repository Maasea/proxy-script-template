import { CDone, CFetchRequest, CFetchResponse, CRequest, CResponse } from "../types/type";
export default abstract class Client {
    private static instances;
    private _times;
    protected static readonly classNames: {
        QuanX: (name?: string, className?: string, options?: {
            debug?: boolean;
        }) => QuanXClient;
    ...
    request: CRequest;
    response: CResponse;
    protected constructor(name?: string, className?: string, options?: {
        debug?: boolean;
    });
...
declare class SurgeClient extends Client {
...
declare class QuanXClient extends Client {
    static clientAdapter: {
        id: string;
        status: string;
    };
